...
val logregDataPlusHour = logregDataAll.withColumn("Hour",hour(logregDataAll("Timestamp")))
...
val Array(training,test) = logregDataPlusHour.randomSplit(Array(0.7,0.3),seed=12345)
