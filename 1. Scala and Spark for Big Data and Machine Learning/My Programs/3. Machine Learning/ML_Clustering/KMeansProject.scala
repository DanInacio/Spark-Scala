...
val data = (spark.read.option("header","true")
                      ...
                      .format("csv")
                      .load(".\\Data\\Wholesale customers data.csv"))
...
val assembler = (new VectorAssembler().setInputCols(Array("Fresh", "Milk",
                                                          "Grocery", "Frozen",
                                                          "Detergents_Paper",
                                                          "Delicassen"))
...
val kmeans = new KMeans().setK(6).setSeed(1L) // tested until error was plateau-ing
